...
export default function Footer1() {
  return (
    <footer className="bg-[#1e1e1e] text-white py-12 px-6 font-sans">
      <div className="max-w-6xl mx-auto">
        
        {/* TOP SECTION: 5-COLUMN NAVIGATION */}
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 text-center mb-12">
          
          {/* Column 1: Info */}
          <div>
            <h4 className="font-extrabold uppercase tracking-wider text-base mb-4">
              Info
            </h4>
            <ul className="space-y-2 text-xs text-gray-300">
              <li><a href="#" className="hover:underline">Terms and Conditions</a></li>
              <li><a href="#" className="hover:underline">Cookies</a></li>
              <li><a href="#" className="hover:underline">Privacy Politics</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs text-gray-300">
              ...
              <li><a href="#" className="hover:underline">Confirmed</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs text-gray-300">
              <li><a href="#" className="hover:underline">Customer</a></li>
          ...
          {/* Column 5: Follow Us (Social Media Icons) */}
          <div>
            <h4 className="font-extrabold uppercase tracking-wider text-base mb-4">
              Follow Us
            </h4>
            <div className="flex justify-center gap-3">
              {/* Facebook */}
              <a href="#" className="p-1 hover:opacity-80 transition" aria-label="Facebook">
              ...
              {/* YouTube */}
              <a href="#" className="p-1 hover:opacity-80 transition" aria-label="YouTube">
                <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
                  <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/>
                </svg>
              </a>
              {/* Instagram */}
              <a href="#" className="p-1 hover:opacity-80 transition" aria-label="Instagram">
                <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
              ...
              {/* Twitter / X */}
              <a href="#" className="p-1 hover:opacity-80 transition" aria-label="Twitter">
                <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
        ...
        <div className="flex justify-center items-center gap-4 pt-6 border-t border-gray-800">
          {/* Amex */}
          <span className="bg-white text-black text-[10px] font-extrabold px-1.5 py-0.5 rounded tracking-tighter uppercase">
           <FaCcAmex size={28}/>
          </span>
